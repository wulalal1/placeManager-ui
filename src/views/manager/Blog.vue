<template>
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="cover" label="封面">
          <template v-slot="scope">
            <div style="display: flex; align-items : center">
              <el-image style="width: 60px; height:50px; border-radius:5px" v-if="scope.row.cover"
        ...
        <el-table-column label="操作" width="180">
          <template v-slot="scope">
            <el-button plain type="primary" @click="handleEdit(scope.row)" plain size="mini">编辑</el-button>
            <el-button plain type="danger" size="mini" plain @click=del(scope.row.id)>删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog title="信息内容" :visible.sync="fromVisible1" width="60%" :close-on-click-modal="false" destroy-on-close>
      <div class="w-e-text">

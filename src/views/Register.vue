<template>
  <div class="container">
    <div style="width: 400px; padding: 30px; background-color: white; rgba(255,255,255,.9); border-radius: 5px;">
      <div style="text-align: center; font-size: 20px; margin-bottom: 20px; color: #333">欢迎注册羽毛球场地管理系统</div>
      <el-form :model="form" :rules="rules" ref="formRef">
        ...
        <el-form-item>
          <el-button size="medium" style="width: 100%; background-color: #647dd5; border-color: #405dc0; color: white" @click="register">注 册</el-button>
        </el-form-item>
